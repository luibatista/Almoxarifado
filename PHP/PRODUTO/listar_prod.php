...
<body>
    ...
    <div class="header-admin">
        ...
        <div>
            ...
            <a href="cad_prod.php" class="btn-new">+ Novo Produto</a>
        </div>
    </div>
    ...
    <table class="table_admin">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="excluir_prod.php?id=<?php echo $row['id']; ?>" class="btn-delete" onclick="return confirm('Tem certeza?');">Excluir</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </tbody>
