...
<body>
    ...
    <div class="container">
        ...
        <section class="box_itens_search_box">
            ...
            <article class="frame">
                <h3 style="padding: 10px; color: #135911;">Categoria: Informática</h3>
                
                <div class="line_frame">
                    <?php 
                    // FILTRA SÓ INFORMÁTICA
                    $sql = "SELECT * FROM produtos WHERE categoria = 'Informática'";
                    ...
                    <?php 
                        ...
                        echo "<p style='padding:20px; color: #666;'>Nenhum item de informática cadastrado.</p>";
                    }
                    ?>
                </div>
            </article>
