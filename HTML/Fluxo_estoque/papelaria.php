...
<body>
    ...
    <div class="container">
        ...
        <section class="box_itens_search_box">
            ...
            <article class="frame">
                <h3 style="padding: 10px; color: #135911;">Categoria: Papelaria</h3>
                
                <div class="line_frame">
                    <?php 
                    // FILTRA SÓ PAPELARIA
                    $sql = "SELECT * FROM produtos WHERE categoria = 'Papelaria'";
                    ...
                    <?php 
                        ...
                        echo "<p style='padding:20px; color: #666;'>Nenhum item de papelaria cadastrado.</p>";
                    }
                    ?>
                </div>
            </article>
