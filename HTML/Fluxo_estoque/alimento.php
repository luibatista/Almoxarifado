...
<body>
    ...
    <div class="container">
        ...
        <section class="box_itens_search_box">
            ...
            <article class="frame">
                <h3 style="padding: 10px; color: #135911;">Categoria: Alimentos</h3>
                
                <div class="line_frame">
                    <?php 
                    // FILTRA SÓ ALIMENTOS
                    $sql = "SELECT * FROM produtos WHERE categoria = 'Alimento'";
                    ...
                    <?php 
                        ...
                        echo "<p style='padding:20px; color: #666;'>Nenhum alimento cadastrado no sistema.</p>";
                    }
                    ?>
                </div>
            </article>
